...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,300 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-19 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,247 | 🐛 70 | 🌐 Dart | 📅 2026-08-19 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,456 | 🐛 990 | 🌐 TypeScript | 📅 2026-08-19 - The Firebase Command Line Tools.
