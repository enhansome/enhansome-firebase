...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,300 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-22 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,250 | 🐛 66 | 🌐 Dart | 📅 2026-08-21 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,806 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-21 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,217 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-22 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,457 | 🐛 997 | 🌐 TypeScript | 📅 2026-08-21 - The Firebase Command Line Tools.
