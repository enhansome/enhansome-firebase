...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,435 | 🐛 17 | 🌐 PHP | 📅 2026-08-11 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,809 | 🐛 203 | 🌐 TypeScript | 📅 2026-08-12 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,872 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-12 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,710 | 🐛 118 | 🌐 Kotlin | 📅 2026-08-12 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-12 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,244 | 🐛 71 | 🌐 Dart | 📅 2026-08-12 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,803 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-12 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,216 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-13 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-12 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,453 | 🐛 1,003 | 🌐 TypeScript | 📅 2026-08-13 - The Firebase Command Line Tools.
...
[Thanks goes to these contributors](https://github.com/jthegedus/awesome-firebase/graphs/contributors) ⭐ 795 | 🐛 7 | 📅 2024-04-06!
