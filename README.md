...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,872 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-24 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-21 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,719 | 🐛 118 | 🌐 Kotlin | 📅 2026-08-17 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-24 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,252 | 🐛 64 | 🌐 Dart | 📅 2026-08-24 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,808 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-24 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,218 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-24 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,460 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-24 - The Firebase Command Line Tools.
