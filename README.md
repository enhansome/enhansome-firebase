...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,434 | 🐛 18 | 🌐 PHP | 📅 2026-09-22 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,800 | 🐛 200 | 🌐 TypeScript | 📅 2026-09-22 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,876 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-22 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,570 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-22 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,733 | 🐛 107 | 🌐 Kotlin | 📅 2026-09-23 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔧 [FirelordJS](https://github.com/tylim88/FirelordJS) ⭐ 96 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-23 - Extremely High Precision Typescript Wrapper for Firestore Web. ([Admin version](https://github.com/tylim88/Firelord) ⭐ 41 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-31)
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,309 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-23 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,259 | 🐛 84 | 🌐 Dart | 📅 2026-09-23 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,806 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-22 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,593 | 🐛 0 | 🌐 Swift | 📅 2026-09-21 - iOS UI bindings for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,213 | 🐛 157 | 🌐 JavaScript | 📅 2026-09-23 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-22 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,473 | 🐛 1,049 | 🌐 TypeScript | 📅 2026-09-23 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-22 - Web UI for Firebase Emulator Suite.
