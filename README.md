...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,435 | 🐛 18 | 🌐 PHP | 📅 2026-08-27 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-30 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,252 | 🐛 66 | 🌐 Dart | 📅 2026-08-28 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,805 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-29 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,219 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-30 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
