...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,434 | 🐛 18 | 🌐 PHP | 📅 2026-09-20 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,877 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-17 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,733 | 🐛 95 | 🌐 Kotlin | 📅 2026-09-21 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,308 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-21 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,259 | 🐛 76 | 🌐 Dart | 📅 2026-09-16 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,806 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-17 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,214 | 🐛 157 | 🌐 JavaScript | 📅 2026-09-21 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,474 | 🐛 1,039 | 🌐 TypeScript | 📅 2026-09-19 - The Firebase Command Line Tools.
