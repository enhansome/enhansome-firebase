...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,434 | 🐛 17 | 🌐 PHP | 📅 2026-09-13 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,804 | 🐛 199 | 🌐 TypeScript | 📅 2026-09-02 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,876 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-14 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Firebase Hooks](https://github.com/CSFrequency/react-firebase-hooks) ⭐ 3,632 | 🐛 43 | 🌐 TypeScript | 📅 2024-04-22 - React Hooks for Firebase services.
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,570 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-15 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,731 | 🐛 116 | 🌐 Kotlin | 📅 2026-09-09 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔧 [Typesaurus](https://github.com/kossnocorp/typesaurus) ⭐ 442 | 🐛 31 | 🌐 TypeScript | 📅 2024-06-30 - Type-safe TypeScript-first ODM for Firestore.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,309 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-16 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,251 | 🐛 74 | 🌐 Dart | 📅 2026-09-16 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,805 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-17 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,593 | 🐛 2 | 🌐 Swift | 📅 2026-09-16 - iOS UI bindings for Firebase.
* 🔌 [GeoFire for Objective-C](https://github.com/firebase/geofire-objc) ⭐ 447 | 🐛 28 | 🌐 Objective-C | 📅 2025-10-15 - Realtime location queries with Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,216 | 🐛 199 | 🌐 JavaScript | 📅 2026-09-17 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Pyrebase](https://github.com/thisbejim/Pyrebase) ⭐ 2,070 | 🐛 237 | 🌐 Python | 📅 2024-05-14 - A simple python wrapper for the Firebase API.
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-15 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firetable](https://github.com/AntlerVC/firetable) ⭐ 6,840 | 🐛 81 | 🌐 TypeScript | 📅 2024-11-23 - Excel/Google Sheets like UI for Firebase/Firestore. No more admin portals!
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,469 | 🐛 1,012 | 🌐 TypeScript | 📅 2026-09-16 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-14 - Web UI for Firebase Emulator Suite.
...
* 🔧 [Fuego](https://github.com/sgarciac/fuego) ⭐ 226 | 🐛 6 | 🌐 Go | 📅 2025-11-27 - Firestore client CLI supporting document add/update/query with filtering and pagination.
...
* 🔧 [Flank](https://github.com/flank/flank/) ⭐ 699 | 🐛 74 | 🌐 Kotlin | 📅 2026-06-20 - Massively parallel Android and iOS test runner for Firebase Test Lab.
