...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,800 | 🐛 198 | 🌐 TypeScript | 📅 2026-09-24 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,876 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-24 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 128 | 🌐 JavaScript | 📅 2026-09-24 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,733 | 🐛 94 | 🌐 Kotlin | 📅 2026-09-25 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,311 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-24 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,259 | 🐛 83 | 🌐 Dart | 📅 2026-09-24 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,807 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-24 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,593 | 🐛 3 | 🌐 Swift | 📅 2026-09-24 - iOS UI bindings for Firebase.
* 🔌 [GeoFire for Objective-C](https://github.com/firebase/geofire-objc) ⭐ 447 | 🐛 29 | 🌐 Objective-C | 📅 2025-10-15 - Realtime location queries with Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,214 | 🐛 156 | 🌐 JavaScript | 📅 2026-09-25 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,473 | 🐛 1,045 | 🌐 TypeScript | 📅 2026-09-24 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-24 - Web UI for Firebase Emulator Suite.
