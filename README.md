...
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-28 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-28 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,251 | 🐛 65 | 🌐 Dart | 📅 2026-08-28 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,807 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-28 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,219 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-29 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,463 | 🐛 994 | 🌐 TypeScript | 📅 2026-08-29 - The Firebase Command Line Tools.
