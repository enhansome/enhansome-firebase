...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,874 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-08 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-08 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
* 💡 [Angular Firebase PWA](https://github.com/codediodeio/angular-firestarter) ⭐ 959 | 🐛 45 | 🌐 TypeScript | 📅 2023-01-07 - Is an Angular PWA powered by Firebase. It can serve as a foundation to learn this stack and roll out more complex features.
...
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,253 | 🐛 81 | 🌐 Dart | 📅 2026-09-08 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,805 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-08 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,219 | 🐛 198 | 🌐 JavaScript | 📅 2026-09-09 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,465 | 🐛 1,002 | 🌐 TypeScript | 📅 2026-09-09 - The Firebase Command Line Tools.
