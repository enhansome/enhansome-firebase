...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,876 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-25 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,311 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-25 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,259 | 🐛 87 | 🌐 Dart | 📅 2026-09-25 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,593 | 🐛 4 | 🌐 Swift | 📅 2026-09-25 - iOS UI bindings for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,212 | 🐛 157 | 🌐 JavaScript | 📅 2026-09-26 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-25 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,474 | 🐛 1,053 | 🌐 TypeScript | 📅 2026-09-26 - The Firebase Command Line Tools.
