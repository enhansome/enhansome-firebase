...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,436 | 🐛 18 | 🌐 PHP | 📅 2026-08-11 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔧 [Experimental Firebase Extensions](https://github.com/FirebaseExtended/experimental-extensions) ⭐ 251 | 🐛 33 | 🌐 TypeScript | 📅 2026-06-21 -  laboratory for new extensions created by Firebase.
* 🔧 [Typesense Extension for Full-Text Search](https://github.com/typesense/firestore-typesense-search) ⭐ 182 | 🐛 23 | 🌐 JavaScript | 📅 2026-05-14 - Official Typesense extension to add full-text search in Firestore, by syncing the data to [Typesense](https://github.com/typesense/typesense) ⭐ 26,435 | 🐛 868 | 🌐 C++ | 📅 2026-08-10, an OSS alternative to Algolia.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,808 | 🐛 202 | 🌐 TypeScript | 📅 2026-08-13 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,872 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
* 🔌 [VueFire](https://github.com/vuejs/vuefire) ⭐ 3,909 | 🐛 45 | 🌐 TypeScript | 📅 2026-04-15 - Firebase bindings for Vue.js.
* 💡 [FirePad](https://github.com/FirebaseExtended/firepad) ⚠️ Archived - Collaborative Text Editor Powered by Firebase.
* 🔌 [React Firebase Hooks](https://github.com/CSFrequency/react-firebase-hooks) ⭐ 3,635 | 🐛 43 | 🌐 TypeScript | 📅 2024-04-22 - React Hooks for Firebase services.
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,572 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-12 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-13 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,711 | 🐛 117 | 🌐 Kotlin | 📅 2026-08-13 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
* 🔌 [SvelteFire](https://github.com/codediodeio/sveltefire) ⭐ 1,661 | 🐛 68 | 🌐 TypeScript | 📅 2024-07-25 - Cybernetically enhanced Firebase apps.
...
* 💡 [Angular Firebase PWA](https://github.com/codediodeio/angular-firestarter) ⭐ 962 | 🐛 45 | 🌐 TypeScript | 📅 2023-01-07 - Is an Angular PWA powered by Firebase. It can serve as a foundation to learn this stack and roll out more complex features.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-13 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,243 | 🐛 72 | 🌐 Dart | 📅 2026-08-13 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,803 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-14 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,592 | 🐛 0 | 🌐 Swift | 📅 2026-08-11 - iOS UI bindings for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,217 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-13 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firetable](https://github.com/AntlerVC/firetable) ⭐ 6,835 | 🐛 77 | 🌐 TypeScript | 📅 2024-11-23 - Excel/Google Sheets like UI for Firebase/Firestore. No more admin portals!
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,454 | 🐛 1,004 | 🌐 TypeScript | 📅 2026-08-14 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-12 - Web UI for Firebase Emulator Suite.
...
[Thanks goes to these contributors](https://github.com/jthegedus/awesome-firebase/graphs/contributors) ⭐ 795 | 🐛 8 | 📅 2024-04-06!
