...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,434 | 🐛 17 | 🌐 PHP | 📅 2026-09-07 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,872 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-07 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,726 | 🐛 117 | 🌐 Kotlin | 📅 2026-09-08 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-08 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,253 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,805 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-08 - Optimized UI components for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,219 | 🐛 198 | 🌐 JavaScript | 📅 2026-09-08 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-07 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,464 | 🐛 1,004 | 🌐 TypeScript | 📅 2026-09-07 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-07 - Web UI for Firebase Emulator Suite.
