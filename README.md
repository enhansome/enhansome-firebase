...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,435 | 🐛 18 | 🌐 PHP | 📅 2026-09-03 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,804 | 🐛 198 | 🌐 TypeScript | 📅 2026-09-02 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,870 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-03 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-03 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-03 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
* 🔌 [Re-base](https://github.com/tylermcginnis/re-base) ⭐ 2,101 | 🐛 22 | 🌐 JavaScript | 📅 2018-07-23 - Relay inspired library for building React.js + Firebase applications.
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,723 | 🐛 116 | 🌐 Kotlin | 📅 2026-09-03 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 💡 [Angular Firebase PWA](https://github.com/codediodeio/angular-firestarter) ⭐ 960 | 🐛 45 | 🌐 TypeScript | 📅 2023-01-07 - Is an Angular PWA powered by Firebase. It can serve as a foundation to learn this stack and roll out more complex features.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-04 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,254 | 🐛 72 | 🌐 Dart | 📅 2026-09-02 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,804 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-03 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,593 | 🐛 0 | 🌐 Swift | 📅 2026-09-03 - iOS UI bindings for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,219 | 🐛 198 | 🌐 JavaScript | 📅 2026-09-04 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Pyrebase](https://github.com/thisbejim/Pyrebase) ⭐ 2,072 | 🐛 237 | 🌐 Python | 📅 2024-05-14 - A simple python wrapper for the Firebase API.
* 🔌 [Integrify](https://github.com/anishkny/integrify) ⭐ 110 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-29 - Enforce referential and data integrity in Firestore using pre-canned Cloud Functions triggers.
...
* 🔧 [Firetable](https://github.com/AntlerVC/firetable) ⭐ 6,839 | 🐛 79 | 🌐 TypeScript | 📅 2024-11-23 - Excel/Google Sheets like UI for Firebase/Firestore. No more admin portals!
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,464 | 🐛 995 | 🌐 TypeScript | 📅 2026-09-04 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-04 - Web UI for Firebase Emulator Suite.
