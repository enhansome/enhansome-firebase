...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,435 | 🐛 19 | 🌐 PHP | 📅 2026-08-20 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,806 | 🐛 195 | 🌐 TypeScript | 📅 2026-08-20 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,874 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-20 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-20 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,300 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-20 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,247 | 🐛 70 | 🌐 Dart | 📅 2026-08-20 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,217 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-20 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,456 | 🐛 989 | 🌐 TypeScript | 📅 2026-08-21 - The Firebase Command Line Tools.
