...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,436 | 🐛 21 | 🌐 PHP | 📅 2026-08-16 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,874 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,245 | 🐛 71 | 🌐 Dart | 📅 2026-08-14 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,218 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-16 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firetable](https://github.com/AntlerVC/firetable) ⭐ 6,834 | 🐛 79 | 🌐 TypeScript | 📅 2024-11-23 - Excel/Google Sheets like UI for Firebase/Firestore. No more admin portals!
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,455 | 🐛 1,008 | 🌐 TypeScript | 📅 2026-08-15 - The Firebase Command Line Tools.
