...
* 🔧 [(Unofficial) Firebase Admin SDK for PHP](https://github.com/kreait/firebase-php) ⭐ 2,435 | 🐛 17 | 🌐 PHP | 📅 2026-08-30 - The Firebase Admin PHP SDK enables access to Firebase services from privileged environments (such as servers or cloud) in PHP.
...
* 🔌 [Angular Fire 2](https://github.com/angular/angularfire2) ⭐ 7,804 | 🐛 196 | 🌐 TypeScript | 📅 2026-08-21 - Official library for Firebase and Angular.
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,871 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-27 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
* 🔌 [VueFire](https://github.com/vuejs/vuefire) ⭐ 3,910 | 🐛 46 | 🌐 TypeScript | 📅 2026-04-15 - Firebase bindings for Vue.js.
...
* 🔌 [React Fire](https://github.com/FirebaseExtended/reactfire) ⭐ 3,571 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-25 - Official Firebase React library with Hooks, Context Providers, and Components that make it easy to interact with Firebase.
* 🔌 [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase) ⭐ 2,533 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-30 - Redux bindings for Firebase. Includes Higher Order Component for use with React.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,720 | 🐛 114 | 🌐 Kotlin | 📅 2026-08-30 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔧 [Typesaurus](https://github.com/kossnocorp/typesaurus) ⭐ 442 | 🐛 32 | 🌐 TypeScript | 📅 2024-06-30 - Type-safe TypeScript-first ODM for Firestore.
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,252 | 🐛 67 | 🌐 Dart | 📅 2026-08-28 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,805 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-31 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,592 | 🐛 0 | 🌐 Swift | 📅 2026-08-26 - iOS UI bindings for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,220 | 🐛 198 | 🌐 JavaScript | 📅 2026-08-31 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔌 [Pyrebase](https://github.com/thisbejim/Pyrebase) ⭐ 2,073 | 🐛 237 | 🌐 Python | 📅 2024-05-14 - A simple python wrapper for the Firebase API.
...
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,463 | 🐛 999 | 🌐 TypeScript | 📅 2026-08-29 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-30 - Web UI for Firebase Emulator Suite.
