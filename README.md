...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-web) ⭐ 4,876 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-09 - FirebaseUI is an open-source JavaScript library for Web that provides simple, customizable UI bindings on top of Firebase SDKs to eliminate boilerplate code and promote best practices.
...
* 🔌 [firebase-kotlin-sdk](https://github.com/GitLiveApp/firebase-kotlin-sdk/) ⭐ 1,729 | 🐛 116 | 🌐 Kotlin | 📅 2026-09-09 - Kotlin-first SDK for Firebase supporting multiplatform projects (`ios`, `android` & `js`).
...
* 🔌 [React Native Firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,305 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-14 - Well-tested feature rich modular Firebase implementation for React Native. Supports both iOS & Android platforms.
* 🔌 [FlutterFire](https://github.com/FirebaseExtended/flutterfire) ⭐ 9,252 | 🐛 83 | 🌐 Dart | 📅 2026-09-12 - Collection of Firebase plugins for [Flutter](https://flutter.io/) apps.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-android) ⭐ 4,804 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-11 - Optimized UI components for Firebase.
...
* 🔌 [Firebase UI](https://github.com/firebase/firebaseui-ios) ⭐ 1,593 | 🐛 1 | 🌐 Swift | 📅 2026-09-11 - iOS UI bindings for Firebase.
...
* 💡 [Functions Samples](https://github.com/firebase/functions-samples) ⭐ 12,218 | 🐛 199 | 🌐 JavaScript | 📅 2026-09-14 - Collection of sample apps showcasing popular use cases using Cloud Functions for Firebase.
...
* 🔧 [Firetable](https://github.com/AntlerVC/firetable) ⭐ 6,843 | 🐛 80 | 🌐 TypeScript | 📅 2024-11-23 - Excel/Google Sheets like UI for Firebase/Firestore. No more admin portals!
* 🔧 [Firebase Tools](https://github.com/firebase/firebase-tools) ⭐ 4,467 | 🐛 1,012 | 🌐 TypeScript | 📅 2026-09-14 - The Firebase Command Line Tools.
* 📖 [Firebase Tools UI](https://github.com/firebase/firebase-tools-ui) ⭐ 291 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-12 - Web UI for Firebase Emulator Suite.
